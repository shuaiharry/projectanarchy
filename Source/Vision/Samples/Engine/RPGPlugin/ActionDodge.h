 ...
 *
 */
#ifndef RPG_PLUGIN_ACTION_DODGE_H__
#define RPG_PLUGIN_ACTION_DODGE_H__

#include <Vision/Samples/Engine/RPGPlugin/Action.h>

class RPG_Action_Dodge : public RPG_Action
{
public:
  RPG_Action_Dodge(RPG_Character *owner);
...
#endif  // RPG_PLUGIN_ACTION_DODGE_H__
