 ...
 *
 */
#ifndef RPG_PLUGIN_ACTION_BLOCK_H__
#define RPG_PLUGIN_ACTION_BLOCK_H__

#include <Vision/Samples/Engine/RPGPlugin/Action.h>

class RPG_Action_Block : public RPG_Action
{
public:
  RPG_Action_Block(RPG_Character *owner);
...
#endif  // RPG_PLUGIN_ACTION_BLOCK_H__
