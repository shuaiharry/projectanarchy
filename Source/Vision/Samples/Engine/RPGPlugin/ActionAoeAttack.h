 ...
 *
 */
#ifndef RPG_PLUGIN_ACTION_AOE_ATTACK_H__
#define RPG_PLUGIN_ACTION_AOE_ATTACK_H__

#include <Vision/Samples/Engine/RPGPlugin/Action.h>
#include <Vision/Samples/Engine/RPGPlugin/ActionAttackBase.h>

class RPG_Action_AoeAttack : public RPG_Action_AttackBase
{
public:
  RPG_Action_AoeAttack(RPG_Character *owner);
...
#endif  // RPG_PLUGIN_ACTION_AOE_ATTACK_H__
