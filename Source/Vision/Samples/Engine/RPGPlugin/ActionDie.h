 ...
 *
 */
#ifndef RPG_PLUGIN_ACTION_DIE_H__
#define RPG_PLUGIN_ACTION_DIE_H__

#include <Vision/Samples/Engine/RPGPlugin/Action.h>

class RPG_Action_Die : public RPG_Action
{
public:
  RPG_Action_Die(RPG_Character *owner);
...
#endif  // RPG_PLUGIN_ACTION_DIE_H__
