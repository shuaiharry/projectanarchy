 ...
 *
 */
#ifndef RPG_PLUGIN_ACTION_RANGED_ATTACK_H__
#define RPG_PLUGIN_ACTION_RANGED_ATTACK_H__

#include <Vision/Samples/Engine/RPGPlugin/Action.h>
#include <Vision/Samples/Engine/RPGPlugin/ActionAttackBase.h>

class RPG_Action_RangedAttack : public RPG_Action_AttackBase
{
public:
  RPG_Action_RangedAttack(RPG_Character *owner);
...
protected:
  ...
  VString m_behaviorChargeStartEventName;
};
