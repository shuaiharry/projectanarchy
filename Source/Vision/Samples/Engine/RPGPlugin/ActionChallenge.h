 ...
 *
 */
#ifndef RPG_PLUGIN_ACTION_CHALLENGE_H__
#define RPG_PLUGIN_ACTION_CHALLENGE_H__

#include <Vision/Samples/Engine/RPGPlugin/Action.h>

class RPG_Action_Challenge : public RPG_Action
{
public:
  RPG_Action_Challenge(RPG_Character *owner);
